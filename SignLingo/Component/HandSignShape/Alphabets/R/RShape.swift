...
struct RShape: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        path.addQuadCurve(to: p(59, 72), control: p(57, 78))
        path.addLine(to: p(57, 64))
        
        path.move(to: p(52, 76))
...
//        path.addLine(to: p(52, 15))
        
//        path.addQuadCurve(to: p(60, 14), control: p(58, 10))
        
        path.addQuadCurve(to: p(50, 26), control: p(45, 15))
        path.addLine(to: p(63, 50))
        
        path.move(to: p(52, 17))
        path.addQuadCurve(to: p(75, 50), control: p(75, 50))
        path.addQuadCurve(to: p(83, 74), control: p(85, 72))
