...
struct KShape: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        path.addQuadCurve(to: p(71, 48), control: p(58, 25))
        ...
        path.addLine(to: p(71, 48))
        path.move(to: p(63, 48))
        path.addQuadCurve(to: p(69, 67), control: p(64, 70))
